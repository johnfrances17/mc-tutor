    ...
    let query = supabase
      ...
      .select(`
        *,
        ...
        tutor:users!sessions_tutor_id_fkey(school_id, first_name, middle_name, last_name, profile_picture),
        tutee:users!sessions_tutee_id_fkey(school_id, first_name, middle_name, last_name, profile_picture)
      `, { count: 'exact' });
